	...
	public void actualiza(Pair<Object, Integer> data) {
		...
		case Event.RES_REGISTER_DEPARTMENT_OK:
			JOptionPane.showMessageDialog(null,
					"Department " + data.getKey() + " has been correctly insertes into the database.", "Success",
					JOptionPane.INFORMATION_MESSAGE);
			this._leftPane.addInfoToComboBox();
			break;

		case Event.RES_REGISTER_DEPARTMENT_FAILED:
			JOptionPane.showMessageDialog(this, "Error entering the department in the database.", "Failed",
					JOptionPane.ERROR_MESSAGE);
			break;

		case Event.RES_UNSUBSCRIBE_DEPARTMENT_OK:
			JOptionPane.showMessageDialog(null,
					"The Department " + data.getKey() + " has been successfully unsubscribed.", "Success",
					JOptionPane.INFORMATION_MESSAGE);
			this._leftPane.addInfoToComboBox();
		...
		case Event.RES_UNSUBSCRIBE_DEPARTMENT_FAILED:
			JOptionPane.showMessageDialog(this, "Error while removing the department in the database.", "Failed",
					JOptionPane.ERROR_MESSAGE);
			break;

		case Event.RES_MODIFY_DEPARTMENT_OK:
			JOptionPane.showMessageDialog(this, "Department correctly updated in the database.", "Success",
					JOptionPane.INFORMATION_MESSAGE);
		...
		case Event.RES_MODIFY_DEPARTMENT_FAILED:
			JOptionPane.showMessageDialog(this, "Error while modifying the department in the database.", "Failed",
					JOptionPane.ERROR_MESSAGE);
			break;
		...
		case Event.RES_READ_DEPARTMENT_FAILED:
			JOptionPane.showMessageDialog(this, "Error showing the department in the database.", "Failed",
					JOptionPane.ERROR_MESSAGE);
			break;
		...
		case Event.CALCULAR_NOMINA_DEPARTAMENTO_FAILED:
			JOptionPane.showMessageDialog(this, "No se ha podido mostrar la nomina", "Failed",
					JOptionPane.ERROR_MESSAGE);
			break;
