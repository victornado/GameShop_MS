	...
	public void actualiza(Pair<Object, Integer> data) {
		...
		case Event.RES_REGISTER_CONFERENCE_OK:
			JOptionPane.showMessageDialog(null,
					"Conference " + data.getKey() + " has been correctly insertes into the database.", "Success",
					JOptionPane.INFORMATION_MESSAGE);
			this._leftPane.addInfoToComboBox();
			break;

		case Event.RES_REGISTER_CONFERENCE_FAILED:
			JOptionPane.showMessageDialog(this, "Error entering the conference in the database.", "Failed",
					JOptionPane.ERROR_MESSAGE);
			break;

		case Event.RES_UNSUBSCRIBE_CONFERENCE_OK:
			JOptionPane.showMessageDialog(null,
					"The conference " + data.getKey() + " has been successfully unsubscribed.", "Success",
					JOptionPane.INFORMATION_MESSAGE);
			this._leftPane.addInfoToComboBox();
		...
		case Event.RES_UNSUBSCRIBE_CONFERENCE_FAILED:
			JOptionPane.showMessageDialog(this, "Error while removing the conference in the database.", "Failed",
					JOptionPane.ERROR_MESSAGE);
			break;

		case Event.RES_MODIFY_CONFERENCE_OK:
			JOptionPane.showMessageDialog(this, "Conference correctly updated in the database.", "Success",
					JOptionPane.INFORMATION_MESSAGE);
		...
		case Event.RES_MODIFY_CONFERENCE_FAILED:
			JOptionPane.showMessageDialog(this, "Error while modifying the conference in the database.", "Failed",
					JOptionPane.ERROR_MESSAGE);
			break;
		...
		case Event.RES_READ_CONFERENCE_FAILED:
			JOptionPane.showMessageDialog(this, "Error showing the conference in the database.", "Failed",
					JOptionPane.ERROR_MESSAGE);
			break;
