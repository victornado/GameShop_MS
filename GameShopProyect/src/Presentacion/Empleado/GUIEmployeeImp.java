	...
	public void actualiza(Pair<Object, Integer> data) {
		...
		case Event.RES_REGISTER_EMPLOYEE_OK:
			JOptionPane.showMessageDialog(null,
					"Employee " + data.getKey() + " has been correctly insertes into the database.", "Success",
		...
		case Event.RES_REGISTER_EMPLOYEE_FAILED:
			JOptionPane.showMessageDialog(this, "Error entering the Employee in the database.", "Failed",
					JOptionPane.ERROR_MESSAGE);
			break;

		case Event.RES_UNSUBSCRIBE_EMPLOYEE_OK:
			JOptionPane.showMessageDialog(null,
					"The Employee " + data.getKey() + " has been successfully unsubscribed.", "Success",
					JOptionPane.INFORMATION_MESSAGE);
			this._leftPane.addInfoToComboBox();
			this._rightPane.update(this._leftPane.getElectionForm());
			break;
		...
		case Event.RES_UNSUBSCRIBE_EMPLOYEE_FAILED:
			JOptionPane.showMessageDialog(this, "Error while removing the employee in the database.", "Failed",
					JOptionPane.ERROR_MESSAGE);
			break;

		case Event.RES_MODIFY_EMPLOYEE_OK:
			JOptionPane.showMessageDialog(this, "Employee correctly updated in the database.", "Success",
					JOptionPane.INFORMATION_MESSAGE);
		...
		case Event.RES_MODIFY_EMPLOYEE_FAILED:
			JOptionPane.showMessageDialog(this, "Error while modifying the employee in the database.", "Failed",
					JOptionPane.ERROR_MESSAGE);
			break;
		...
		case Event.RES_READ_EMPLOYEE_FAILED:
			JOptionPane.showMessageDialog(this, "Error showing the employee in the database.", "Failed",
					JOptionPane.ERROR_MESSAGE);
			break;
